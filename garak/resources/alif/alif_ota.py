...
# Particle swarm optimizer taken from https://github.com/TASER2023/TASER/blob/main/optimizer.py under MIT license
...
def alif_ota():
    ...
    for e in range(epoch):
        ...
        for i in range(len(audios)):
            ...
            print("trans:", trans)
            cer1 = edit_distance(ori_trans, trans) / len(ori_trans)
            trans = get_trans(os.path.join(root, savedir), noisy_name)
            print("noisy:", trans)
            cer2 = edit_distance(ori_trans, trans) / len(ori_trans)
